...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'root@mels11-n1bsql.hosting-services.net.au';
  ...
  */
   ...
   * by SERVER_NAME is used or 'mels11-n1bsql.hosting-services.net.au.localdomain'.
   * @var string
   */
  public $Hostname          = '';
   ...
   * @var string
   */
  public $Host          = 'mels11-n1bsql.hosting-services.net.au';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or 'mels11-n1bsql.hosting-services.net.au.localdomain' if unknown.
   * @access protected
   * @return string
   */
  protected function ServerHostname() {
    if (!empty($this->Hostname)) {
      ...
      $result = 'mels11-n1bsql.hosting-services.net.au.localdomain';
    }
