...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="mels11-n1bsql.hosting-services.net.au" /></td>
			<td><?php _e( 'You should be able to get this info from your web host, if <code>mels11-n1bsql.hosting-services.net.au</code> does not work.' ); ?></td>
		</tr>
		<tr>
