...
/*.logo-wrapper{ 
	...
	margin-bottom: <?php echo get_option(THEME_SHORT_NAME . "_logo_bottom_margin", '10'); ?>px;
}*/
.navigation-wrapper{
...
div.gdl-page-caption{
	color: <?php echo get_option(THEME_SHORT_NAME.'_caption_color', '#FFF'); ?>;
}
.sidebar-title-color{
...
.page-id-491 div.jcarousellite-nav .prev, 
.page-id-491 div.jcarousellite-nav .next{ background-image: url('<?php echo GOODLAYERS_PATH; ?>/images/icon/<?php echo $gdl_icon_type; ?>/navigation-custom.png'); } 
