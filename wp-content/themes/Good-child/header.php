...
<head>
  ...
  ================================================== -->
	...
	<?php if( $gdl_is_responsive ){ ?>
        ...
        <link rel="stylesheet" href="<?php echo GOODLAYERS_PATH; ?>/fonts.css"  type="text/css">
	<?php }else{ ?>
	...
	<div class="container">
		<div class="header-wrapper">
			...
			<div class="navigation-wrapper">
				<?php wp_nav_menu( array('container' => 'div', 'container_class' => 'menu-wrapper', 'container_id' => 'main-superfish-wrapper', 'menu_class'=> 'sf-menu',  'theme_location' => '' ) ); ?>
			</div>
			<?php 
				if( $gdl_is_responsive ){
					dropdown_menu( array('dropdown_title' => '-- Main Menu --', 'indent_string' => '- ', 'indent_after' => '','container' => 'div', 'container_class' => 'responsive-menu-wrapper', 'theme_location'=>'') );	
				}
